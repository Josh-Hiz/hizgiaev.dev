...
const $$BaseLayout = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<html lang="en" data-astro-cid-37fxchfa> <head><!-- General --><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0"><meta name="generator"${addAttribute(Astro2.generator, "content")}><meta name="description"${addAttribute(description, "content")}><link rel="icon" type="image/png" href="/favicon-96x96.png" sizes="96x96"><link rel="icon" type="image/svg+xml" href="/favicon.svg"><link rel="shortcut icon" href="/favicon.ico"><link rel="apple-touch-icon" sizes="180x180" href="/apple-touch-icon.png"><meta name="apple-mobile-web-app-title" content="hizgiaev.dev"><link rel="manifest" href="/site.webmanifest"><title>${title}</title>${renderComponent($$result, "Font", $$Font, { "cssVariable": "--font-geist", "preload": true, "data-astro-cid-37fxchfa": true })}${renderComponent($$result, "ClientRouter", $$ClientRouter, { "data-astro-cid-37fxchfa": true })}${renderComponent($$result, "LoadingIndicator", $$LoadingIndicator, { "color": "#f4f4f5", "height": "2px", "data-astro-cid-37fxchfa": true })}${renderHead()}</head> <body class="font-sans bg-zinc-900 min-h-screen" data-astro-cid-37fxchfa> ${renderSlot($$result, $$slots["default"])} </body></html>`;
